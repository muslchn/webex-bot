...
if choice == 'N' or choice == 'n':
	accessToken = "Bearer" + input("Input the token: ")
else:
	accessToken = "Bearer NGU1Y2Y3ODAtNGM0Yi00YzBhLWE1YmYtYzg3OGVjY2I2MDI2Y2YyMGUxZDAtYzAw_P0A1_77d2afa7-517c-48a4-8826-a1e760aefa35"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "ZDOkCEjlxLJiq2b7SoT5a4bW79qFPMYG"
                               }
# 7. Provide the URL to the MapQuest address API.
